const GradientSquare = ({ className = '', children }) => {
  return (
    <div className={`relative -rotate-45  ${className}`}>
      <div
        className={` w-[4.5rem] h-[4.5rem] sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-gradient-to-r-square rounded-md grid place-content-center shadow-lg`}
      >
        <h6 className="text-white text-xs  font-normal sm:font-medium rotate-45 text-center">
          {children}
        </h6>
      </div>
